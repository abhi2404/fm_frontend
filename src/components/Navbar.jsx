...
const Navbar = ({ setLoggedIn, loggedIn }) => {
  ...
  return (
    <header className="flex flex-wrap fixed top-0 sm:justify-start sm:flex-nowrap z-50 w-full sm:bg-transparent bg-white text-sm py-4 dark:bg-gray-800">
      <nav
      ...
      >
        <div className="flex items-center justify-between">
          <a
            className="inline-flex items-center gap-x-2 text-xl font-semibold sm:text-white text-slate-600"
            href="#"
          >
            <svg
        ...
        >
          <div className="flex flex-col gap-5 mt-5 sm:flex-row sm:items-center sm:justify-end sm:mt-0 sm:pl-5">
            <Link
              className="font-medium text-slate-800 hover:text-gray-400"
              to="/"
              aria-current="page"
            >
              Register
            ...
            {!loggedIn ? (
              <Link
                className="font-medium text-slate-800 hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-500"
                to="/login"
              >
                Login
              </Link>
